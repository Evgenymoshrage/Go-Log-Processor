...
| ---------- | -------------------------------------- | --------------------------------------------------  |
| processor  | TestLoadLogs, TestProcessLogs,         | Корректность чтения CSV, параллельную обработку,    |
|            | TestFilterLogs, TestSummaryStatistics  | фильтрацию логов и подсчёт статистики               |
| ---------- | -------------------------------------- | --------------------------------------------------  |
| utilits    | TestLogEntryToString                   | Форматирование структуры LogEntry в красивую строку |
| ---------- | -------------------------------------- | --------------------------------------------------  |
